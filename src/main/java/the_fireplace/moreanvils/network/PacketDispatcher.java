...
public class PacketDispatcher {
    ...
    private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(MoreAnvils.MODID);

    public static final void registerPackets() {
        PacketDispatcher.registerMessage(UpdateRenameMessage.Handler.class, UpdateRenameMessage.class, Side.SERVER);
    }
